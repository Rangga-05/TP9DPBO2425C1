...
// Class ini bertanggung jawab untuk mengatur koneksi ke database MySQL menggunakan PDO (PHP Data Objects).
class DB{
    ...
    private $conn; // Menyimpan objek koneksi PDO setelah berhasil terhubung
    private $result; // Menyimpan hasil dari eksekusi query
    ...
    function __construct($host, $db_name, $username, $password) {
        ...
        $this->conn = $this->connect(); // Membuat koneksi saat objek DB dibuat
    }
