...
// Class ini merepresentasikan satu entitas data Pembalap yang bertugas menyimpan dan mengelola data Pembalap
class Pembalap{

    // Atribut data Pembalap
    private $id;
    private $nama;
    private $tim;
    private $negara;
    ...
    // Constructor untuk inisialisasi objek Pembalap
